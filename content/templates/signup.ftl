...
<body class="text-center">
    <form class="form-signin" method="post">
        ...
        <input type="text" id="inputSurname" class="form-control" name="surname" placeholder="Surname" required autofocus><br/>
        <label for="inputImage" class="sr-only">Image</label>
        <input type="text" id="inputImage" class="form-control" name="imageUrl" placeholder="Image Url" required autofocus><br/>
        ...
        <input type="password" id="inputPassword" class="form-control" name="password" placeholder="Password" required autofocus><br/>
